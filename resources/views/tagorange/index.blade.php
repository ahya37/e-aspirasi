...
<div class="page-wrapper">
        <div class="page-content">
				...
				<h6 class="mb-0 ">Tag Orange</h6>
				<hr/>
				<div class="card col-md-12 col-sm-12">
					<div class="card-body">
                        <a href="{{ route('tagorange.create') }}" class="btn btn-primary btn-sm float-right mb-4"><i class="lni lni-circle-plus"></i> Tambah Baru</a>
						<div class="table">
...
<script src="{{ asset('/js/tagorange.js') }}"></script>
@endpush