...
<div class="page-wrapper">
        <div class="page-content">
				...
				<div class="card col-md-12 col-sm-12">
					<div class="card-body">
                        <a href="{{ route('jamaah.create') }}" class="btn btn-primary btn-sm float-right mb-4"><i class="lni lni-circle-plus"></i> Tambah Baru</a>
						<div class="table">
...
<script src="{{ asset('/js/jamaah.js') }}"></script>
@endpush