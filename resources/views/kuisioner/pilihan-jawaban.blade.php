...
<div class="page-wrapper">
	<div class="page-content">
        ...
        @include('layouts.message')
				<h6 class="mb-0 ">Pilihan Jawaban Kuisioner</h6>
				<hr/>
				<div class="card">
					<div class="card-body">
                        <button  type="button" onclick="addKategoriPilihanJawaban()" class="btn btn-primary btn-sm float-right mb-4"><i class="lni lni-circle-plus"></i> Tambah Baru</button>
...
<script src="{{ asset('/js/kategori-pilihan.js') }}"></script>
@endpush