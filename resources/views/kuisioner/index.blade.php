...
<div class="page-wrapper">
        ...
        @include('layouts.message')
				...
				<div class="card">
					<div class="card-body">
                        <a href="{{ route('kusioner.create') }}" class="btn btn-primary btn-sm float-right mb-4"><i class="lni lni-circle-plus"></i> Tambah Baru</a>
                        <a href="{{ route('kusioner.kategoripilihan') }}" class="btn btn-primary btn-sm float-right mb-4"><i class="fa fa-eye"></i> Pilihan Jawaban</a>
