...
<div class="page-wrapper">
		...
		<input type="hidden" value="{{$id}}" id="aktivitasId">
				...
				<h6 class="mb-0 ">Detail Tugas Umrah - <span class="text-success">Status Dilaksanakan (Y)</span></h6>
				...
				<div class="card">
					<div class="card-body">
						<div class="table-responsive">
							<table id="listData" class="table table-hover" style="width: 50%">
								<thead>
									<tr>
										<th></th>
										<th>No</th>
...
<script src="{{ asset('/js/detail-activitas-umrah-status-y.js') }}"></script>
@endpush