...
async function modalAddJudul(id) {
  ...
  const sopAPI = `/tugas/sop/petugas/count/alphabet/${id}`;
  ...
  if (formValues) {
    // ajax save judul
    $.ajax({
      url: "/tugas/sop/petugas/judul/save",
      method: "POST",
      data: {
        id: id,
        nomor: formValues[0],
...
async function modalEditJudul(nomor, judul, id) {
  ...
  if (formValues) {
    // ajax edit judul
    $.ajax({
      url: "/tugas/sop/petugas/judul/update",
      method: "POST",
      data: {
        id: id,
        nomor: formValues[0],
...
async function modaAddTugas(judul, id, sopId) {
  ...
  const sopAPI = `/tugas/sop/petugas/count/tugas/${id}`;
  ...
  if (formValues) {
    // ajax edit judul
    $.ajax({
      url: "/tugas/sop/petugas/judul/tugas/save",
      method: "POST",
      data: {
        id: id,
        nomor: formValues[0],
...
async function updateTugas(element) {
  ...
  if (formValues) {
    // ajax edit judul
    $.ajax({
      url: "/tugas/sop/petugas/judul/tugas/update",
      method: "POST",
      data: {
        id: id,
        nomor: formValues[0],
...
async function settingUploadFileSop(element) {
  ...
  const CSRF_TOKEN = $('meta[name="csrf-token"]').attr("content");
  $.ajax({
    url: `/tugas/sop/petugas/settinguploadfile`,
    method: "POST",
    cache: false,
    data: {
      id: id,
